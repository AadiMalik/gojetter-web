                ...
                <table class="table table-hover order-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(booking, index) in bookings" :key="booking.id">
                            ...
                            <td>
                                <button class="btn btn-sm view-btn btn-outline-primary"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="order-detail-item">
                                        ...
                                        <div>{{ selectedBooking.address }}, {{ selectedBooking.country }} {{
                                            selectedBooking.zipcode }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
