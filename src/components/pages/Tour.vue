              ...
              <div class="row">
                <div class="col-lg-3 col-md-6 mb-3">
                  <select class="form-select" v-model="selectedDestination" @change="fetchTours">
                    ...
                    <option v-for="destination in destinations" :key="destination" :value="destination.id">
                      {{ destination.name }}
                    </option>
                  </select>
                </div>
                ...
                <div class="tour-card">
                  <div class="tour-image">
                    ...
                    <div class="tour-price">
                      <template v-if="tour.discount_price && tour.discount_price > 0">
                        <del class="text-danger">{{ currency.format(tour.price)
                          }}</del>
                        <br>
                  ...
                  <div class="tour-content">
                    ...
                    <div class="row">
                      <div class="col-md-2" style="background:#008cad; border-radius: 20px; text-align: center;">
                        <router-link :to="`/tour-detail/${tour.slug}`" title="View Tour" class="bt-outline-primary"
                      ...
                      <div class="col-md-2"
                        ...
                        <span class="bi bi-heart" style="font-size: 20px; color:#fff; cursor:pointer;"></span>
                      </div>
                    </div>
                  </div>
                </div>
